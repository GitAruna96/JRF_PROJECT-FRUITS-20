...
# Load your results
df = pd.read_csv('C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\fruits_dataset\\paper_experiments\\results\\swin_t_mkmmd_1_results_20250909_151104.csv')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/1. mkmmd_accuracy_curve.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/1. mkmmd_accuracy_curve.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/2. mkmmd_loss_components.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/2. mkmmd_loss_components.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/3. mkmmd_timing_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/3. mkmmd_timing_analysis.pdf', bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.savefig(f'{plot_dir}/4.mkmmd_time_accuracy_tradeoff.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/4. mkmmd_time_accuracy_tradeoff.pdf', bbox_inches='tight')
plt.show()
...
ax1.set_title('A) MKMMD Performance: FO → FP Domain Adaptation', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/5.mkmmd_combined_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/5. mkmmd_combined_analysis.pdf', bbox_inches='tight')
plt.show()

# 6. Quantitative Analysis Report
print("=== MKMMD TRAINING ANALYSIS REPORT ===")
...
summary_df.to_csv(f'{plot_dir}/MKMMD_performance_summary.csv', index=False)
print(f"\nAnalysis summary saved to: {plot_dir}/MKMMD_performance_summary.csv")