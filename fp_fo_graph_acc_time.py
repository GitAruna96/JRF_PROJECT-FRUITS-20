...
# Setup
# =========================
csv_path = r'./results\\swin_small_patch4_window7_224_sac_reverse_f_sac_predcon_results_20250924_121657.csv'
plot_dir = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\fruits_dataset\\paper_experiments\\sac_plots\\fp_fo_bigsize'
...
ax1.legend(lines1 + lines2, labels1 + labels2, 
           loc='center right', frameon=True, framealpha=0.95,
...
plt.title("Accuracy vs Training Time (FP->FO)", fontweight="bold", fontsize=13, pad=15)
plt.tight_layout()
plt.savefig(f"{plot_dir}/FP_FO_accuracy_time_fixed.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/FP_FO_accuracy_time_fixed.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.suptitle("SAC Domain Adaptation Analysis: FP to FO (Fruits dataset)", 
             fontsize=15, fontweight="bold", y=0.98)
plt.tight_layout()
plt.subplots_adjust(top=0.93, wspace=0.3, hspace=0.4)

plt.savefig(f"{plot_dir}/FP_FO_training_analysis_fixed.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/FP_FO_training_analysis_fixed.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
ax1.set_title("Test Accuracy (FP→FO)", fontweight="bold", fontsize=13)
...
plt.tight_layout()
plt.savefig(f"{plot_dir}/FP_FO_separate_plots.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/FP_FO_separate_plots.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
print("\n" + "="*60)
print("SAC DOMAIN ADAPTATION SUMMARY - FP to FO ")
print("="*60)
