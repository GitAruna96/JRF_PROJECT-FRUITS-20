...
def save_history_to_csv(history, model_name, output_dir):
    ...
    csv_path = os.path.join(output_dir, f'{model_name}_f_sac_predcon_1_results_{timestamp}.csv')
   ...
   # Initialize model, optimizer, and loss functions
    ...
    for epoch in range(num_epochs):
        ...
        if test_acc > best_acc:
            ...
            # Save regular model
            torch.save(model.state_dict(), os.path.join(output_dir, f'f_sac_rev_pred_1_best_{model_name}.pth'))
    ...
    # Save results
    save_history_to_csv(history, f'{model_name}_ssc_rev_predcheck1_early_stop', output_dir)
