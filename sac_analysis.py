...
csv_path = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\fruits_dataset\\paper_experiments\\recovered_best_results_78.45.csv'
df = pd.read_csv(csv_path)

# Create output directory for plots
plot_dir = './results/sac_plots'
...
plt.axhline(y=78.33, color='red', linestyle='--', linewidth=2, label='Baseline (78.33%)')
plt.axhline(y=best_acc, color='green', linestyle='--', linewidth=2, label=f'Best SAC ({best_acc:.1f}%)')

plt.xlabel('Epoch', fontsize=14, fontweight='bold')
plt.ylabel('Accuracy (%)', fontsize=14, fontweight='bold')
plt.title('SAC Performance: Domain Adaptation with Spectral Anchor Consistency\n(Swin-T Backbone)', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/1. sac_accuracy_curve.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/1. sac_accuracy_curve.pdf', bbox_inches='tight')
plt.show()
...
plt.title('Loss Components: SAC Training Dynamics\n(Spectral Anchor Consistency)', fontsize=16, fontweight='bold')
plt.legend(fontsize=12)
plt.grid(True, alpha=0.3)
plt.yscale('log')  # Log scale to see all components clearly

plt.tight_layout()
plt.savefig(f'{plot_dir}/2. sac_loss_components.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/2. sac_loss_components.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/3. sac_confidence_schedule.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/3. sac_confidence_schedule.pdf', bbox_inches='tight')
plt.show()
...
plt.title('Computational Efficiency: SAC Training Time\n(Swin-T + Spectral Anchor Consistency) Total_time = 14.76 min', fontsize=16, fontweight='bold')
plt.legend(fontsize=12)
plt.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig(f'{plot_dir}/4. sac_timing_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/4. sac_timing_analysis.pdf', bbox_inches='tight')
plt.show()
...
ax1.axhline(y=78.33, color='red', linestyle='--', linewidth=2, label='Baseline (78.33%)')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/5. sac_combined_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/5. sac_combined_analysis.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/6. sac_vs_baseline.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/6. sac_vs_baseline.pdf', bbox_inches='tight')
plt.show()
...
print(f"Baseline Accuracy: 78.33%")
print(f"Improvement: {best_acc-78.33:+.2f}%")
...
summary = {
    ...
    'Baseline_Accuracy': 78.33,
    'Improvement': best_acc - 78.33,
...
summary_df.to_csv(f'{plot_dir}/sac_performance_summary.csv', index=False)
print(f"\nAnalysis summary saved to: {plot_dir}/sac_performance_summary.csv")

print(f"\n🎉 All plots saved to: {plot_dir}/")
print("✓ 1. sac_accuracy_curve.png")
print("✓ 2. sac_loss_components.png") 
print("✓ 3. sac_confidence_schedule.png")
print("✓ 4. sac_timing_analysis.png")
print("✓ 5. sac_combined_analysis.png")
print("✓ 6. sac_vs_baseline.png")
print("✓ sac_performance_summary.csv")