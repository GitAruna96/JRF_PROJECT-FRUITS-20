...
# Setup
# =========================
csv_path = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\fruits_dataset\\paper_experiments\\recovered_50epochs.csv'
plot_dir = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\fruits_dataset\\paper_experiments\\sac_plots\\fo_fp_bigsize'
...
plt.title("Accuracy vs Training Time (FO->FP)", fontweight="bold", fontsize=13, pad=15)
plt.tight_layout()
plt.savefig(f"{plot_dir}/FO_FP_accuracy_time_fixed.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/FO_FP_accuracy_time_fixed.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.suptitle("SAC Domain Adaptation Analysis: FO to FP (Fruits dataset)", 
             fontsize=15, fontweight="bold", y=0.98)
plt.tight_layout()
plt.subplots_adjust(top=0.93, wspace=0.3, hspace=0.4)

plt.savefig(f"{plot_dir}/FO_FP_training_analysis_fixed.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/FO_FP_training_analysis_fixed.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
ax1.set_title("Test Accuracy (FO→FP)", fontweight="bold", fontsize=13)
...
plt.tight_layout()
plt.savefig(f"{plot_dir}/FO_FP_separate_plots.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/FO_FP_separate_plots.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
print("\n" + "="*60)
print("SAC DOMAIN ADAPTATION SUMMARY - FO to FP ")
print("="*60)
